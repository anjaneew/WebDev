...
//defining
let article: readonly [number, string, boolean] = [1, "X-Men rocks", true];
let movie: [number, string, boolean] = [2, "Game of Thrones", true];
...
let software: readonly [number, string, boolean] = [4.2, "VSCode", true];
...
let game: [number, string, boolean] = [101, "Chess", false];
