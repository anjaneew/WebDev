...
let arrayTwo = ["apple", "orange", "coconut"];
//a mixture of numeric and string values - Multidimensional????
let arrayThree = [1, 2, 3, 4, "apple", "orange", "coconut"];
//My note: This is Multidimensional Array
let mixedMultiArray = [[1, "apple soda", 2.85],
    [2, "backing soda", 0.75],
    [3, "citric acid", 1.85]];
//---------------------------Exercises--------------------------------------
...
let mixedList = [99, "train", 45, "ship", 78, "bus"];
